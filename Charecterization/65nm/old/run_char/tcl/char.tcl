...
set MODEL_INCLUDE_FILE   ${SRC_DIR}/models/spectre/umc
...
char_library -auto_index -extsim spectre -cells $cells 
##-thread $THREAD
...
write_datasheet -format text ${RUN_DIR}/DATASHEET/example
